 ...
 '66-Revelation']
  ...
  methods: {
    ...
    handle_verses(){
        ...
        if (this.target_file!='All'){
            ...
            console.log(temp_edition, temp_book, temp_chap)
            ...
            var temp_verses=['All',... temp_filt.map(d=>d['Verse'])]
          ...
          var temp_edition=this.target_folder
          console.log(temp_edition, this.loaded_file)
          var temp_filt=this.loaded_file.map(d=>d.filter(function(y){
            ...
            this.target_verses=temp_verses
            this.target_verse=this.target_verse[0]
            this.displayable_verses=temp_verses
            console.log(temp_verses)
        }
  ...
  watch: {
    ...
    target_folder: function () {
        ...
        this.target_chap=this.target_files[1]
      ...
      this.target_file = this.target_files[this.target_folder_idx]; //0==All
      this.read_file()
    ...
    target_chap: function(){
        //this.target_chap=this.target_chaps[1]
